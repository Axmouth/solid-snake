    ...
    ($opcode:ident, $ty:ty) => {
        paste! {
            ...
            fn [<$opcode handler>](
                ...
                let (reg_ptr, reg_value, reg_offset) = [<$opcode Instruction>]::parse_args(look_ahead);
    ...
    ($opcode:ident, $ty:ty) => {
        paste! {
            ...
            fn [<$opcode handler>](
                ...
                let (section_idx, reg_value, reg_offset) = [<$opcode Instruction>]::parse_args(look_ahead);
