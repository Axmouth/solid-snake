    ...
    ($opcode:ident, $ty:ty) => {
        paste! {
            ...
            pub fn [<$opcode handler>](
                ...
                assert_eq!(look_ahead.len(), [<$opcode Instruction>]::arg_size());
                let (reg, val) = [<$opcode Instruction>]::parse_args(look_ahead);
    ...
    ($opcode:ident, $ty:ty) => {
        paste! {
            ...
            pub fn [<$opcode handler>](
                ...
                assert_eq!(look_ahead.len(), [<$opcode Instruction>]::arg_size());
                let (reg_ptr, dest) = [<$opcode Instruction>]::parse_args(look_ahead);
    ...
    ($opcode:ident, $ty:ty) => {
        paste! {
            ...
            pub fn [<$opcode handler>](
                ...
                assert_eq!(look_ahead.len(), [<$opcode Instruction>]::arg_size());
                let (reg_dest, addr) = [<$opcode Instruction>]::parse_args(look_ahead);
    ...
    ($opcode:ident, $ty:ty) => {
        paste! {
            ...
            fn [<$opcode handler>](
                ...
                let (reg_dest, reg_ptr, reg_offset) = [<$opcode Instruction>]::parse_args(look_ahead);
