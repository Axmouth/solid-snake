...
#[derive(Debug, TryFromPrimitive, EnumString, PartialEq, Clone, Copy)]
#[repr(u16)]
pub enum OpCode {
    // TODO: Jump indirect?
    ...
    // StoreFromImmediate: Store to a constant address from a register — i.e., store value into a hardcoded address.
    StoreIndirectU8 = 80,
    StoreIndirectU16 = 81,
    StoreIndirectU32 = 82,
    StoreIndirectU64 = 83,
    ...
    // Logical operations are applied only to u8 operands used as booleans
    LogicalAnd = 150,
    LogicalOr = 151,
    LogicalNot = 152,
    LogicalXor = 153,
